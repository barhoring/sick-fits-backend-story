...
const CommitSelector = ({ ids, currentHash, prevHash, nextHash, thisHash }) => {
  ...
  return (
    <div>
      ...
      >
        <Link
          to={`/commits/${prevHash}`}
          className={!prevHash ? classes.disabledLink : null}
        >
          <CommitNavButton disabled={!prevHash}>Previous Commit</CommitNavButton>
        </Link>
        ...
        <Link
          to={`/commits/${nextHash}`}
          className={!nextHash ? classes.disabledLink : null}
        >
          {/* <Link to={nextHash ? `/commits/${nextHash}` : '/'}  className={!nextHash ? classes.disabledLink : null}> */}
          <CommitNavButton disabled={!nextHash}>Next Commit</CommitNavButton>
        </Link>
      </div>
    </div>
  )
